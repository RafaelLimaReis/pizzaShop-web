...
import { GetOrdersResponseInterface } from '@/api/get-orders'
...
export interface OrderTableRowPropsInterface {
    order: {
        orderId: string
        createdAt: string
...
export function OrderTableRow({ order }: OrderTableRowPropsInterface) {
    const [isDetailsOpen, setIsDetailsOpen] = useState(false)
    const queryClient = useQueryClient()

    function updateOrderStatusOnCache(orderId: string, status: OrderStatusType) {
        const ordersListCache = queryClient.getQueriesData<GetOrdersResponseInterface>({
            queryKey: ['orders'],
        })
        ...
        ordersListCache.forEach(([cacheKey, cacheData]) => {
            ...
            queryClient.setQueryData<GetOrdersResponseInterface>(cacheKey, {
                ...cacheData,
